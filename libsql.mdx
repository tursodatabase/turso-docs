...
| -------------------------------------------- | ----------------------------------- |
| [JSON](https://www.sqlite.org/json1.html)    | Work with JSON data in SQLite.      |
| [FTS5](https://www.sqlite.org/fts5.html)     | Full-text search and indexing.      |
| [R\*Tree](https://www.sqlite.org/rtree.html) | Indexing and querying spatial data. |
...
| ----------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------- |
| [sqlite-vec](https://github.com/asg017/sqlite-vec)                            | 0.1.0   | The Vector Search successor to `sqlite-vss`.                                |
| [SQLean Crypto](https://github.com/nalgeon/sqlean/blob/main/docs/crypto.md)   | 0.24.1  | Hashing, message digest, encoding, and decoding.                            |
| [SQLean Fuzzy](https://github.com/nalgeon/sqlean/blob/main/docs/fuzzy.md)     | 0.24.1  | Fuzzy string matching and phonetics. A fork of Spellfix1 with improvements. |
| [SQLean Math](https://github.com/nalgeon/sqlean/blob/main/docs/math.md)       | 0.24.1  | Advanced mathematical calculations.                                         |
| [SQLean Regexp](https://github.com/nalgeon/sqlean/blob/main/docs/regexp.md)   | 0.24.1  | Regular expressions with SQLite.                                            |
| [SQLean Stats](https://github.com/nalgeon/sqlean/blob/main/docs/stats.md)     | 0.24.1  | Common statistical functions with SQLite.                                   |
| [SQLean Text](https://github.com/nalgeon/sqlean/blob/main/docs/text.md)       | 0.24.1  | String manipulation (reverse, split) with SQLite.                           |
| [SQLean Unicode](https://github.com/nalgeon/sqlean/blob/main/docs/unicode.md) | 0.24.1  | Case-insensitive string comparison for Unicode strings.                     |
| [SQLean UUID](https://github.com/nalgeon/sqlean/blob/main/docs/uuid.md)       | 0.24.1  | Limited support for RFC 4122 compliant UUIDs.                               |

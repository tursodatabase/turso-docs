...
| [sqlite-vec](https://github.com/asg017/sqlite-vec)                            | 0.1.0    | Opt-in    | The Vector Search successor to `sqlite-vss`.                                |
| [SQLean Crypto](https://github.com/nalgeon/sqlean/blob/main/docs/crypto.md)   | 0.24.1   | Opt-in    | Hashing, message digest, encoding, and decoding.                            |
| [SQLean Fuzzy](https://github.com/nalgeon/sqlean/blob/main/docs/fuzzy.md)     | 0.24.1   | Opt-in    | Fuzzy string matching and phonetics. A fork of Spellfix1 with improvements. |
| [SQLean Math](https://github.com/nalgeon/sqlean/blob/main/docs/math.md)       | 0.24.1   | Opt-in    | Advanced mathematical calculations.                                         |
| [SQLean Regexp](https://github.com/nalgeon/sqlean/blob/main/docs/regexp.md)   | 0.24.1   | Opt-in    | Regular expressions with SQLite.                                            |
| [SQLean Stats](https://github.com/nalgeon/sqlean/blob/main/docs/stats.md)     | 0.24.1   | Opt-in    | Common statistical functions with SQLite.                                   |
| [SQLean Text](https://github.com/nalgeon/sqlean/blob/main/docs/text.md)       | 0.24.1   | Opt-in    | String manipulation (reverse, split) with SQLite.                           |
| [SQLean Unicode](https://github.com/nalgeon/sqlean/blob/main/docs/unicode.md) | 0.24.1   | Opt-in    | Case-insensitive string comparison for Unicode strings.                     |
| [SQLean UUID](https://github.com/nalgeon/sqlean/blob/main/docs/uuid.md)       | 0.24.1   | Opt-in    | Limited support for RFC 4122 compliant UUIDs.                               |     |

...
Clients can interact with the Turso server with the [Hrana over HTTP](https://github.com/tursodatabase/libsql/blob/main/docs/HTTP_V2_SPEC.md) protocol. In the following example, we'll see how to perform a basic query, as well explain the core concepts of the protocol.

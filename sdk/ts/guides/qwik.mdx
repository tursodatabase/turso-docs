...
export const useFrameworks = routeLoader$(
  async (requestEvent: RequestEventBase) => {
    ...
    const stmt = await db.prepare("select * from table_name");
...
<CardGroup cols={2}>
  <Card
    ...
    icon="github"
    href="https://github.com/tursodatabase/examples/tree/master/app-find-me-on"
  >
  ...
  <Card
    title="Shopping Cart"
    icon="github"
    href="https://github.com/tursodatabase/examples/tree/master/app-turqw-store"
  >
    See the full source code
  </Card>
</CardGroup>

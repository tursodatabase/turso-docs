...
All databases are part of a "group", dictating their primary storage location and replication across distinct VMs ([locations](#locations)), each capped at 100GB. This setup ensures databases share resources yet remain isolated.

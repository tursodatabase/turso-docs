...
We are working with the Drizzle team to enable support for database migrations. If you see `SQLite error: no such table: __drizzle_migrations`, this is why. [Join us on Discord](https://discord.gg/turso) to follow the progress.

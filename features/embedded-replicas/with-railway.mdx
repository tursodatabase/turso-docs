...
title: Turso + Railway
sidebarTitle: 
description: Deploy a NodeJs app using [Turso embedded replicas](/features/embedded-replicas) to [Railway](https://railway.app/).
---
...
<CardGroup cols={2}>
    ...
    <Card
        title="Web traffic API with Turso Embedded replicas + Actix Web"
        icon="github"
        href="https://github.com/tursodatabase/web_traffic_checker"
    >
    See the full source code
    </Card>
</CardGroup>

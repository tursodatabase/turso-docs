...
title: Turso + Railway
sidebarTitle: 
description: Deploy a Rust app using [Turso Cloud embedded replicas](/features/embedded-replicas) to [Railway](https://railway.app/).
---
...
<Step title="Get application code">
    ...
    <Card
        title="Recipe book API with Turso Cloud Embedded Replicas + Actix Web"
        icon="github"

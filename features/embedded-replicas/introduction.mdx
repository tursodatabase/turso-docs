---
title: Introduction to Embedded Replicas
...
<Card
   ...
   <Snippet file="fly-logo.svg" />

   **Turso + Fly**

   Deploy NodeJs project with Embedded Replicas to Fly.io
</Card>

<Card
   href="/features/embedded-replicas/with-koyeb"
   >

   <Snippet file="koyeb-logo.svg" />
   
   **Turso + Koyeb**

   Deploy NodeJs project with Embedded Replicas to Koyeb
</Card>

<Card
   href="/features/embedded-replicas/with-railway"
   >

   <Snippet file="railway-logo.svg" />
   
   **Turso + Railway**

   Deploy NodeJs project with Embedded Replicas to Railway
</Card>

<Card
   href="/features/embedded-replicas/with-render">

   <Snippet file="render-logo.svg" />
   
   **Turso + Render**

   Deploy NodeJs project with Embedded Replicas to Render
</Card>

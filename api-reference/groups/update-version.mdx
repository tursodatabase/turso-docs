...
openapi: "POST /v1/organizations/{organizationName}/grooups/{groupName}/update"
---
...
```bash cURL
curl -L -X POST 'https://api.turso.tech/v1/organization/{organizationName}/groups/{groupName}/update' \

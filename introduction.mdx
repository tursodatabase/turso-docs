...
<CardGroup cols={2}>
  ...
  >
    Get zero latency reads with a replica on-device.
  </Card>
  <Card title="Multi-DB Schemas" icon="user" href="/features/multi-db-schemas">
    Create and share schema across multiple databases.
  </Card>
  <Card title="Edge Replicas" icon="globe" href="/features/data-edge">
    Get low latency data access with edge replicas.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Client SDKs" icon="brackets-curly" href="/sdk">
    Connect and ontegrate Turso into your application with one of our libSQL
    drivers.
  </Card>

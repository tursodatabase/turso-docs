...
- Have a Remix app &mdash; [learn more]
...
export const turso = (serverContext: AppLoadContext) => createClient({
...
<CardGroup cols={2}>
  ...
  <Card
   title="A Customer Relationship Management website"
   icon="arrow-up-right-from-square"
...
[learn more]: https://remix.run/docs/en/main/start/quickstart#quick-start
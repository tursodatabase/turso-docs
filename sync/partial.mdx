...
The client lazily fetches pages of the database file from Turso when a query touches data that is not present locally.
This reduces startup time and network usage for large databases, while remaining fully compatible with push/pull.

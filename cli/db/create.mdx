...
| `--schema <string>`        | The database schema to use ([learn more about multi-db schemas](/features/multi-db-schemas)).                                                                                                                                         |
...
You can create a database with experimental support for SQLite [extensions](/extensions) using the `--enable-extensions` flag:
